/** Simple monochrome brand icons (currentColor) */
...
/** Coding logo: </> (horizontal, not stacked like >_) */
...
/** Inline coding prompt: >_  (single line, for terminals — NOT used on CA hero badge) */
export function PromptMark({ className = '' }: { className?: string }) {
  return (
    <span
      className={`inline-flex items-baseline font-mono font-semibold leading-none ${className}`}
      aria-hidden
    >
